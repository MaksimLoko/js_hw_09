...
var markup = menu_default()(src_menu_namespaceObject); // указываем куда вставить шаблон

var ul = document.querySelector('.js-menu'); // вставляем шаблон в указанное место
...
themeSwitch.addEventListener("change", changeTheme); // делаем переключение темы.
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\"menu__item\">\r\n  <article class=\"card\">\r\n    <img\r\n      src=\""
    ...
    + "\r\n      </p>\r\n      <ul class=\"tag-list\">"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"ingredients") : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":18,"column":27},"end":{"line":20,"column":17}}})) != null ? stack1 : "")
